import "./App.css";
import { Header,MainContent,Footer } from "./component/allComponent.jsx";
import { ProductSection } from "./component/productSection.jsx";
import QuestionAnswer from "./component/QA.jsx"
  ...
  return (
    <section id="faq">
      <h1>FAQ (คำถามที่พบบ่อย)</h1>
        ...
        <QuestionAnswer topic ="Q : What makes XYZ Company's products so unique?" description = "A : At XYZ Company, we pride ourselves on innovation and cutting-edge
          ...
          <QuestionAnswer topic ="Q : How does XYZ Company contribute to sustainability and
            environmental conservation?" description ="A: XYZ Company is committed to environmental responsibility. We
        ...
        <QuestionAnswer topic = " Q : What kind of support can customers expect from XYZ Company's
            customer service team?" description ="A : At XYZ Company, customer satisfaction is our top priority. Our
       ...
       <QuestionAnswer topic = " Q : How does XYZ Company stay ahead of industry trends?" description =" A: XYZ Company stays at the forefront of industry trends through
      ...
      <QuestionAnswer topic = " Q : Can you tell us about XYZ Company's commitment to community
            involvement?" description =" A : XYZ Company is deeply committed to giving back to the communities
